...
class TestUserModel(TestCase):
    def test_can_create_new_user(self):
        User = get_user_model()
        user = User.objects._create_user(email="user@google.com", password="strong")
    ...
    def test_email_and_password_required(self):
        ...
        with self.assertRaises(TypeError):
            User.objects._create_user(email="user@google.com")
        with self.assertRaises(TypeError):
            User.objects._create_user(password="strong")

    def test_email_is_not_empty(self):
        User = get_user_model()
        with self.assertRaises(ValueError):
            User.objects._create_user(email="", password="strong")
    ...
    def test_can_create_company_manager(self):
        ...
        user = User.objects.create_company_manager(
            email="manager@company.com", password="strong", company=company
        )
    ...
    def test_can_create_company_user(self):
        ...
        user = User.objects.create_company_user(
            email="user@company.com", password="strong", company=company
        )
