...
const PropertiesMapPage = () => {
  ...
  const geodataQuery = useQuery(
    ["properties", id, "geodata"],
    () => Api.retrieveMediaFile(retrieveProperty.data?.data?.geodata),
    {
      enabled: retrieveProperty.isSuccess,
    }
  );
  ...
  if (retrieveProperty.isSuccess && geodataQuery.isSuccess) {
